...
process.on('uncaughtException', (error) => {
  if (error.code === 'ENOENT') {
    ...
    console.error(`ERROR: (${error.file}:${error.lineNumber}):`, error.message)
  } else {
    console.error(error)
  }
...
// TODO: Add rules from .gitignore to PARSED_RULES as
// negative rules with the right file reference
